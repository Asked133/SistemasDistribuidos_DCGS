...
public interface IPokemonRepository
{
    ...
    Task<(IReadOnlyList<Pokemon> data, int totalRecords)> GetPokemonsAsync(string name, string type, int pageNumber, int pageSize, string orderBy, string orderDirection, CancellationToken cancellationToken);
}